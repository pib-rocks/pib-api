...
DEFAULT_PYTHON_CODE_DIR = os.path.join(expanduser('~'), "cerebra_programs")     # not used yet

app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv("SQLALCHEMY_DATABASE_URI", DEFAULT_SQL_URI)
